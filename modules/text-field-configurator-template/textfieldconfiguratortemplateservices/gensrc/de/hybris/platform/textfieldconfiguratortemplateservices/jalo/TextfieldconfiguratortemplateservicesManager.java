...
@SLDSafe
public class TextfieldconfiguratortemplateservicesManager extends Extension
{
	...
	public TextFieldConfiguratorSetting createTextFieldConfiguratorSetting(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType("TextFieldConfiguratorSetting");
	...
	public TextFieldConfiguratorOrderedProductInfo createTextFieldConfiguredProductInfo(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType("TextFieldConfiguredProductInfo");
	...
	public static final TextfieldconfiguratortemplateservicesManager getInstance()
	{
		ExtensionManager em = JaloSession.getCurrentSession().getExtensionManager();
		return (TextfieldconfiguratortemplateservicesManager) em.getExtension(TextfieldconfiguratortemplateservicesConstants.EXTENSIONNAME);
	}
