 ...
 *
 * @description
 * This directive generates a custom dropdown (standalone or dependent on another one) for the {@link GenericEditorModule.service:GenericEditorFactoryService GenericEditorFactoryService}.
 * It is an implementation of the PropertyEditorTemplate {@link GenericEditorModule.service:PropertyEditorTemplate contract}.
 * <br/>{@link GenericEditorModule.service:EditorFieldMappingService EditorFieldMappingService} maps seDropdown by default to the "EditableDropdown" cmsStructureType.
 ...
 *
 * @param {= Object} field The field description of the field being edited as defined by the structure API described in {@link GenericEditorModule.service:GenericEditorFactoryService GenericEditorFactoryService}.
